...
//   onActivate: (newClassroom: IClassroom) => void;
// }
...
// const AlertBanner: React.FC<AlertBannerProps> = ({ classroom, onActivate }) => {
...
//           (s: ISemester) => s.classroom_id !== classroom.id
//         );
...
//     setError(null);
//     try {
//       const newSemester = await activateSemester(semester.classroom_id);
...
//     setError(null);
//     try {
//       const newSemester = await deactivateSemester(semester.classroom_id);
//       onActivate(newSemester);
//     } catch (err) {
//       console.log(err);
//       setError(SemesterError.API_ERROR);
